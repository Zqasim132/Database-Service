    ...
    internal class DBComponent_1
    {
        ...
        public bool Read(string client, out long time)
        {
            try
            {
                ...
                var cmd = new SqlCommand("select TOP(1000) * from Contact_Summary_Details", connection);
